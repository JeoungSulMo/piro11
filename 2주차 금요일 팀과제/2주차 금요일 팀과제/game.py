...
class DressUpGame:
    ...
    def equip(self):
        ...
        if item == "티":
            print('내가 가지고 있는 티', self.new_char.bag['TOP'])
            name = input("무슨 티? ")
            ...
            print('내가 가지고 있는 바지', self.new_char.bag['BOTTOM'])
            name = input("무슨 바지? " )
            ...
            print('내가 가지고 있는 모자', self.new_char.bag['HAT'])
            name = input("어떤 모자? ")
            ...
            print('내가 가지고 있는 신발', self.new_char.bag['SHOES'])
            name = input("어떤 신발? ")
